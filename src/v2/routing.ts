...
export const v2ComputeAddress = (token0: string, token1: string) => {
  const [token0Sorted, token1Sorted] =
  ...
  const salt = keccak256(
    ['bytes'],
    [pack(['address', 'address'], [token0Sorted, token1Sorted])]
  );
  const initCodeHash =
    '0x9ac843134bd02f87ccefa1b6ef876991ae932ca19d3e130f9e12e95befc92136'; // Uniswap V2 init code hash
